            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="<?php echo e(route('cms.profile')); ?>"><i class="ti-user text-muted mr-2"></i>
                                Profile</a>
                            <a class="dropdown-item" href="<?php echo e(route('cms.edit_password')); ?>"><i class="ti-wallet text-muted mr-2"></i> My
                                change password</a>
                            <a class="dropdown-item" href="#"><i class="ti-settings text-muted mr-2"></i>
                                Settings</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo e(route('auth.logout')); ?>"><i class="ti-lock text-muted mr-2"></i> Logout</a>
                        </li>
                    </ul>
                </li>
                <li>
...
</header><?php /**PATH C:\xampp\htdocs\ecommerce\ecommerce\resources\views/cms/body/header.blade.php ENDPATH**/ ?>