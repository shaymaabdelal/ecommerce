...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('../assets/vendor_components/toastr/build/toastr.min.css')); ?>">
...
<body class="cnt-home">
    ...
    <script src="<?php echo e(asset('../assets/vendor_components/toastr/build/toastr.min.js')); ?>"></script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="closeModel"><span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
function productView(id){
    $.ajax({
        type: 'GET',
        url: '/shop/product/view/modal/'+id,
        dataType:'json',
...
success:function(data){
    ...
    $.ajax({
    type: 'GET',
    url: '/shop/minicart/product-remove/'+rowId,
    dataType:'json',
    success:function(data){
    miniCart();
    // Start Message
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: "/shop/add-to-wishlist/"+product_id,
            success:function(data){
                // Start Message
                const Toast = Swal.mixin({
                toast: true,
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            url: "<?php echo e(url('/shop/coupon-apply')); ?>",
            success:function(data){
                couponCalculation();
    ...
    $.ajax({
    type: 'GET',
    url: "<?php echo e(url('/shop/coupon-calculation')); ?>",
    dataType: 'json',
    success:function(data){
        if(data.total){
            $('#couponCalField').html(
          ...
          $('#couponCalField').html( `<tr>
                <th>
                    ...
                    <div class="cart-sub-total">
                        copoun name<span class="inner-left-md">${data.coupon_name}</span>
    ...
    <script type="text/javascript">
        function couponRemove(){
            $.ajax({
                type:'GET',
                url: "<?php echo e(url('/shop/coupon-remove')); ?>",
                dataType: 'json',
                success:function(data){
                    couponCalculation();
                    $('#couponField').show();
...
</html><?php /**PATH C:\xampp\htdocs\ecommerce\ecommerce\resources\views/frontend/parant.blade.php ENDPATH**/ ?>